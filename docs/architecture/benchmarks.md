...
[`benchmarks/src/alfworld/cli.ts`](../../benchmarks/src/alfworld/cli.ts)，其它参数仍
...
[`EvaluationRunner`](../../benchmarks/src/alfworld/evaluation-runner.ts) 按 Manifest 顺序
...
[`EvaluationReport`](../../benchmarks/src/alfworld/report.ts) 只保存任务、环境统计、
