...
- `createDefaultPromptBundleProtocolValidator` 对 v1–v3/`checkpoint@1`、v4/`structured@1` 与 v5/`structured@1` + `trajectory-layered@1` 做一一校验；未知版本、非法协议或交叉组合抛出 `GOAL_PROTOCOL_ERROR`，组合根在任何 Goal 保存或模型调用前失败，不回退。
